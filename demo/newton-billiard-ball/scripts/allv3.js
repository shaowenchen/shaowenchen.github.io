...
exports.start = function(){
	...
	ball.config({
		...
		ball: {
			number: 5,
			size: 83,
			image: "/demo/newton-billiard-ball/images/ball.png",
			lineLength: 300,
			angleLimit: [30, 150],
			cycleTime: 800
		}
	...
	var snd = sound.create("/demo/newton-billiard-ball/images/ball_hit.wav"), sndTimeout;
		...
		/* methods */ {
			...
			usePNGbackground: function(image){
				...
				if(/\.png$/i.test(image) && Ucren.isIe6){
					...
					/// 	_background: none;
					///  _filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/demo/newton-billiard-ball/images/pic.png',sizingMethod='scale');
				}else{
